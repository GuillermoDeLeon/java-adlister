//servlet will be used to listen for users trying to view all the Products - likely by going to page like "/products"
// "products/index.jsp"
//"/"
...
public class ShowProductServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        //Get the product y its ID from ListProductsDao
        Product product = productDao.findById(productId);

        //set the attribute "product" to the object we just created
        req.setAttribute("product", product);
        req.getRequestDispatcher("/products/products-show.jsp").forward(req, res);
